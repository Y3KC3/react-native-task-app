      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 2:
            ...
            _context2.next = 5;
            return connection.query('SELECT * FROM task WHERE id = ?', [req.params.id]);
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 2:
            ...
            _context3.next = 5;
            return connection.query('SELECT COUNT(*) FROM task');
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 2:
            ...
            _context4.next = 5;
            return connection.query('INSERT INTO task (title,description) values(?,?)', [req.body.title, req.body.description]);
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 2:
            ...
            _context5.next = 5;
            return connection.query('DELETE FROM task WHERE id = ?', [req.params.id]);
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 2:
            ...
            _context6.next = 5;
            return connection.query('UPDATE task SET ? WHERE id = ?', [req.body, req.params.id]);
